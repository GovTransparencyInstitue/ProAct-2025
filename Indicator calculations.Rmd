...
## Purpose:
## This script defines country-agnostic indicator formulas for public procurement
## transparency and openness. Indicators are designed to be applied one country
## at a time using harmonised ProACT-style contract-level datasets.
...
# country_data()
# --------------------------------------------------
# Loads a single country procurement dataset.
#
# Design choice:
# - Exactly one country is loaded per execution to avoid cross-country
#   dependencies and reduce memory usage.
# - File naming convention is assumed to be <COUNTRY>_export.csv.
#
# Args:
#   country_code : ISO-like country code (e.g. "AT", "DE")
#   data_dir     : Directory containing country export files
#
# Returns:
#   data.table with contract-level procurement data for one country
